...
assert str(sum_lists(LinkedList([1,2,3]), LinkedList([3,2,1]))) == str(LinkedList([4,4,4]))
assert str(sum_lists(LinkedList([7,1,6]), LinkedList([5,9,2]))) == str(LinkedList([2,1,9])) ## 617 + 295 = 912
assert str(sum_lists(LinkedList([1,5,9]), LinkedList([2,3,6,7]))) == str(LinkedList([3,8,5,8]))
assert str(sum_lists(LinkedList([9,7,8]), LinkedList([6,8,5]))) == str(LinkedList([5,6,4,1]))
